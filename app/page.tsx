    ...
    <>
      ...
      <section className="relative -z-20 pt-32 lg:pt-40">
        ...
        <div className="flex items-center justify-center -mt-10 lg:-mt-44 ">
          <Image
            src={Hero}
            alt="Hero"
            className="hidden lg:block lg:max-w-[1200px] lg:mx-auto"
          />
        ...
        <div className="hidden lg:block">
          <Image
            src={Abstract}
            alt=""
            className="w-24 h-24 absolute top-28 right-40"
          />
          <Image
            src={Abstract}
            alt=""
            className="w-24 h-24 absolute top-60 left-32"
          />
          <Image
            src={Abstract}
            alt=""
            className="w-24 h-24 absolute top-96 right-72"
          />
          <Image
            src={Abstract}
            alt=""
            className="w-24 h-24 absolute bottom-96 left-60"
          />
          <Image
            src={Abstract}
            alt=""
            className="w-24 h-24 absolute bottom-80 right-0"
          />
          <Image
            src={Abstract}
            alt=""
      ...
      <section className="px-6 lg:px-0">
        <div className="flex justify-center items-center space-x-4 lg:space-x-8 mt-5 lg:mt-10">
          <Link
            href="https://www.dextools.io/app/en/xrpl/pair-explorer/4B454B4955530000000000000000000000000000.rLWCx7obzMRbFfreNR6eScPz6GWj4xbr4v_XRP?t=1735732303613"
      ...
      <section className="px-6 lg:px-0 mt-20 flex flex-col justify-center items-center">
        <Image
          src={AbstractStory}
          alt=""
          className="w-96 h-60 lg:h-80 object-contain -mt-14 -mb-28 -z-30"
        />
        <Image
          src={String}
          alt=""
          className="absolute -translate-x-[26rem] -translate-y-80 w-96 h-[20.5rem] object-contain -mt-14"
        />
      ...
      <div>
        <Image
          src={AbstractStory}
          alt=""
          className="-mt-40 lg:-mt-64 lg:ml-32 hidden lg:block lg:w-[500px] lg:h-80"
        />
      </div>
